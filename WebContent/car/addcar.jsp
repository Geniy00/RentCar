			...
			<td align="center">
				...
				<form action="" method="post">
					<table align="center" width="85%">
						<tr align="center">
							<td width="100">Mark:</td><td  width="150"><input type="text" name="mark" value="${car.mark}"/></td>
						</tr>
						<tr align="center">
						...
						<tr align="center"><td>Status:</td>
							<td align="left">
								<input type="radio" name="status" value="AVAILABLE"  checked="checked">available<br>
